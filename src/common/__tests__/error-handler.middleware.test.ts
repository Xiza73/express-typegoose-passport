...
describe('Error Handler Middleware', () => {
  ...
  describe('Handling unknown routes', () => {
    it('should returns 404 for unknown routes', async () => {
  ...
  describe('Handling thrown errors', () => {
    it('should handles thrown errors with a 500 status code', async () => {
  ...
  describe('Handling errors passed to next()', () => {
    it('should handles errors passed to next() with a 500 status code', async () => {
